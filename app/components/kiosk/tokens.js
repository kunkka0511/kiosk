...
export const A = {
  ...
  hero:       "/assets/images/fbouz.jpg",            /* IMG hero дэвсгэр (хуучин) */
  // HERO визуал: хорооллын нэгдсэн төлөвлөлтийн render.
  // ⚠ Одоогоор шошготой "All edited.jpg"-г ашиглаж байна. ЦЭВЭР (шошго/легенд-гүй)
  //   render-ийг /public/assets/images/masterplan-clean.png болгож хадгалаад
  //   доорх замыг түүн рүү солих → hero дээр зөвхөн өөрийн лого/текст харагдана.
  heroPlan:   encodeURI("/assets/All edited.jpg"),   /* IMG hero — цэвэр render-ээр солих */
  masterPlan: encodeURI("/assets/All edited.jpg"),   /* IMG ерөнхий төлөвлөгөө (шошготой нь зөв) */
